 ...
 <div class="lampstand-outer">
   <div class="lampstand-inner">
     <label for="input-title">Full Name:</label>
      <input type="text" name="fullname" value="${membersInstance?.fullname}" id="fullname" size="50">
       </div>                                                                                                   
 </div>
    <div class="lampstand-outer lampstand-required">
         <div class="lampstand-inner">
                <label for="email">Email Address</label>
              <input type="text" name="email" id="email" required size="50" value="${membersInstance?.email}">
         </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="lampstand-outer">
                                                                                                <div class="lampstand-inner">
                                                                                                  ...
                                                                                                  <input type="text" name="phone" id="input-phone" placeholder="XXX-XXX-XXXX" value="${membersInstance?.phone}">
                                                                                                </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="lampstand-outer lampstand-required">
                                                                                                <div class="lampstand-inner">
                                                                                                  ...
                                                                                                  <input type="text" name="address" id="address" required size="50">
                                                                                                </div>
                                                                                </div>
                                                                                <div class="lampstand-outer">
                                                                                                <div class="lampstand-inner">
                                                                                                  <label for="address">Address (Optional):</label>
                                                                                                  <input type="text" name="address1" id="address" size="50" placeholder="Apt #, Suite Optional">
                                                                                                </div>
                                                                                </div>
                                                                                <div class="lampstand-outer">
                                                                                                <div class="lampstand-inner">
                                                                                ...
                                                                                <div class="lampstand-outer">
                                                                                                <div class="lampstand-inner">
                                                                                                                ...
                                                                                                                <input type="text" name="city" id="city" placeholder="City" size="20">
                                                                                                                <select name="state">
                                                                                  ...
                                                                                  <option value="WY">Wyoming</option>
                                                                                                                ...
                                                                                                                <input type="text" name="zip" id="zip" placeholder="Zip Code" size="6" maxLength="5">
                                                                                                </div>
                                                                                </div>                                                                  
                                                                                <div class="lampstand-outer lampstand-required">
                                                                                                <div class="lampstand-inner">
