...
<html>
	...
	<body>
		<a href="#create-offering" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-offering" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:offeringInstance, action:'save']" >
				<fieldset class="form">
