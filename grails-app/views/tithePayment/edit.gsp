...
<html>
	...
	<body>
		<a href="#edit-tithePayment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tithePayment" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tithePaymentInstance?.version}" />
				<fieldset class="form">
